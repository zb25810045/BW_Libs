 ...
 */
public class BWItemAnimator extends SimpleItemAnimator {
    ...
    private void animateRemoveImpl(final ViewHolder holder) {
        ...
        animation.setDuration(getRemoveDuration()).alpha(0).translationX(-holder.itemView.getWidth()).setListener(
